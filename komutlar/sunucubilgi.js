...
exports.run = (client, message, args) => {
	...
	const embed = new Discord.RichEmbed()
		...
		.addField(`Emoji Sayısı [${message.guild.emojis.size}]`, `${loglar.prefix}emojiler yazarak sunucudaki bütün emojileri görüntüleyebilirsiniz.`)
		.addField(`Rol Sayısı [${message.guild.roles.size - 1}]`, `${loglar.prefix}roller yazarak sunucudaki bütün rolleri görüntüleyebilirsiniz.`)
